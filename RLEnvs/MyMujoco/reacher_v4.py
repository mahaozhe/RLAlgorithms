...
class ReacherEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, reward_type="sparse", goal_dist_th=0.05, **kwargs):
    ...
    def step(self, a):
        ...
        if self.reward_type == "dense":
            ...
            reward = int(np.linalg.norm(vec) < self.goal_dist_th) - 1  # {-1,0}
            reward_ctrl = 0
    ...
    def _get_obs(self):
        ...
        achieved_goal = self.get_body_com("fingertip").copy()
        desired_goal = self.get_body_com("target").copy()
        return {
