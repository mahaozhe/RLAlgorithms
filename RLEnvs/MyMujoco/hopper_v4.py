...
class HopperEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        self.tgt_speed = np.random.uniform(0.5, 5)
    ...
    def step(self, action):
        ...
        # print(f"==>> reward: {reward} achieved_goal: {observation['achieved_goal']} desired_goal: {observation['desired_goal']}")
    ...
    def reset_model(self):
        ...
        if self.task == "speed":
            self.tgt_speed = gen_rand_num_within(0.5, 5)
