...
class TD3:
    ...
    def __init__(self, env_id, actor_class, critic_class, exp_name="td3", render=False, seed=1, cuda=0, gamma=0.99,
                 buffer_size=1000000, rb_optimize_memory=False, exploration_noise=0.1, policy_regular_noise=0.2,
                 noise_clip=0.5, actor_lr=3e-4, critic_lr=3e-4, batch_size=256, policy_frequency=2, tau=0.005,
                 write_frequency=100, save_folder="./td3/"):
        """
    ...
    def make_env(self, env_id, seed, render):
        ...
        assert isinstance(env.action_space, gym.spaces.Box), "only continuous action space is supported for TD3"
