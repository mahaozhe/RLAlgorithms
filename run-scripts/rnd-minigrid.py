"""
The script to run RND on MiniGrid environments.
"""
...
from Networks.CombinedActorCriticNetworks import RNDMiniGridAgent, RNDMiniGridModel

from utils.env_makers import sync_vector_minigrid_envs_maker


def parse_args():
    parser = argparse.ArgumentParser(description="Run RND on MiniGrid environments.")

    parser.add_argument("--exp-name", type=str, default="rnd-minigrid")
    ...
    parser.add_argument("--save-folder", type=str, default="./rnd-minigrid/")
