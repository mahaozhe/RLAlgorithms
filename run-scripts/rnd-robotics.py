"""
The script to run PPO on my-robotics and my-mujoco environments.
"""

import argparse

from RLAlgos.PPO_RND import PPO_RND

from Networks.CombinedActorCriticNetworks import PPORNDAgent
...
from utils.env_makers import sync_vector_robotics_envs_maker, robotics_env_maker
...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="MyMujoco/Ant-Height09-v4-Sparse")
