"""
The script to run NoisyNet-DQN on classic control environments.
"""
...
from Networks.NoisyNetworks import NoisyQNetClassicControl

from utils.env_makers import classic_control_env_maker


def parse_args():
    parser = argparse.ArgumentParser(description="Run NoisyNet-DQN on classic control environments.")

    parser.add_argument("--exp-name", type=str, default="noisy-net-dqn")
    ...
    parser.add_argument("--save-folder", type=str, default="./noisy-net-dqn/")
...
def run():
    ...
    agent = NoisyNetDQN(env=env, noisy_q_network_class=NoisyQNetClassicControl, exp_name=args.exp_name, seed=args.seed,
